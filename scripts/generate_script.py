...
- 숫자 표기 주의: 이 텍스트는 TTS가 그대로 읽으므로, 숫자를 붙여서 세대나
  줄임말을 표현하는 방식("2030세대", "3040세대" 등)은 쓰지 말 것 — TTS가
  큰 숫자(예: 이천삼십)로 잘못 읽습니다. 대신 "20~30대", "20대·30대"처럼
  풀어서 쓸 것. 그 외에도 숫자가 여러 자리 붙어서 오독될 수 있는 표현은
  피하고, 자연스럽게 읽힐 표기로 쓸 것.
